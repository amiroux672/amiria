...
"https://i.imgur.com/EaA7nKY.jpeg",
	 ...
	 var callback = () => api.sendMessage({body:`هذه صورة لـ Chaeyoung \nعدد الصور المتوفرة: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));	
