...
module.exports.run = async function ({ event, api, args }) {
  ...
  try {
    ...
    for (var friends of dataFriend) {
      listFriend.push({
        name: friends.fullName || "لم يذكر اسمه",
        uid: friends.userID,
    ...
    page < -1 ? page = 1 : "";
    var limit = 10;
    var msg = `💜TOTAL INCLUDES ${countFr} FRIENDS💜\n\n`;
    ...
    return api.sendMessage(msg + 'قم بالرد على رقم طلب الحذف وتدليك الحذف للقلب', event.threadID, (e, data) =>
